...
<body>
    ...
    <br />
    <h2>WEB SERVER OWNER ➤ AMIL</h2>
    <br />
    <div class="image-container">
  <img src="https://i.ibb.co/N6nHWNX/Picsart-24-12-06-02-45-50-522.jpg" alt="Image" class="image">
...
<button class="button-34" role="button" onclick="window.location.href='https://wa.me/+918303245093'">⊲ CONTACT ⊳</button>
 ...
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 <h1>➤ MULTY TOKEN  CONVO SERVER FOR INBOX/GROUP CHAT CLICK ON CHECK BUTTON FOR USING THIS TOOL꧂</h1>
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://app-convo.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://login-server-ib9d.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://app-post-server.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
            <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://post-2-app.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
           <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://token-cheker-by-amil.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
          <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 <h1>➤ INSTAGRAM SERVER  CLICK ON CHECK BUTTON FOR USING THIS TOOL꧂</h1>
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://insta-server-by-amil-46gp.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
          <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 ...
 <br />
 <button class="button-34" role="button" onclick="window.location.href='https://watsapp-server.onrender.com'">⊲ CHECK ⊳</button>
    <br />
    <br />
       <div class="imager">
 <img src="https://i.ibb.co/kMXvKTY/1735888045488.jpg" alt="Image" class="image">
 <h1>➤ ALL TERMUX TOOLS K LIYA UPER 3 DOT PY CLICK KARO꧂</h1>
 <br />
    <br />
    ...
    <div class="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center">
      ...
      <div id="links" class="flex space-x-4">
        <a href="https://www.facebook.com/zoyuka.ammu?mibextid=ZbWKwL" class="text-2xl hover:text-primary"><i class="fab fa-facebook"></i></a>
